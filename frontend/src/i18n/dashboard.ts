...
export const dashboard = {
  en: {
    logout: 'Log out', dashboard: 'Dashboard', yourDashboard: 'Your dashboard', currentPeriod: 'Current period', wordsUsed: 'words used', remaining: 'remaining', unlimited: 'Unlimited', renewsOn: 'Renews on',
    ...
    close: 'Close', checkoutSuccess: 'Payment successful — your plan is upgrading.', checkoutError: 'Something went wrong loading checkout. Please try again.',
  ...
  es: {
    logout: 'Cerrar sesión', dashboard: 'Panel', yourDashboard: 'Tu panel', currentPeriod: 'Periodo actual', wordsUsed: 'palabras usadas', remaining: 'restantes', unlimited: 'Ilimitado', renewsOn: 'Se renueva el',
    ...
    close: 'Cerrar', checkoutSuccess: 'Pago exitoso — tu plan se está actualizando.', checkoutError: 'Algo salió mal al cargar el pago. Inténtalo de nuevo.',
